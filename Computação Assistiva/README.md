...
### 1. Dispositivos Táteis (Impressão 3D)
Desenvolvimento de objetos com identificação em **Braille**. O foco principal foi a criação de um **Suporte para Incenso de Citronela (Incensário)**.
* **Inclusão:** Identificação tátil para autonomia de deficientes visuais.
* **Saúde Pública:** Incentivo ao uso da citronela como repelente natural no combate ao mosquito transmissor da dengue.
* **Design:** Modelagem de peças encaixáveis e seguras.
...
<img src="https://github.com/IF-DeividSilva/ext_program/blob/main/Computa%C3%A7%C3%A3o%20Assistiva/Imgs/img5.jpeg" width="500" height="300" alt="Apresentação">
